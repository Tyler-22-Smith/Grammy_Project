...
# Making Dataframe Grouped Based on Album ID

```{r}
grammy_albums <- grammy |>
  group_by(track_album_id) |>
  summarise(track_album_id = track_album_id,
            artist = artist_main,
            album_featured_artist = sum(artist_number_featured),
            track_featured_artist = mean(artist_number_featured),
            album_duration = sum(track_album),
